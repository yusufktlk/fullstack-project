        ...
        <main className='md:ml-20 mt-8 md:mt-20'>
            ...
            <div className="mt-10 ">
                ...
                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 bg-gray-100 rounded-lg">
                    ...
                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">@jessyschwarz</dd>
                </div>
                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 rounded-lg">
                ...
                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 bg-gray-100 rounded-lg  sm:px-0">
                    <dt className="text-sm font-medium leading-6 text-gray-900 ml-2">About</dt>
                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 tracking-wider md:mr-10">
